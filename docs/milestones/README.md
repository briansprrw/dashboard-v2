...
| M4 | [Management, sharing, and admin](./M4-management-sharing-and-admin.md)               | In Progress (M4.1–M4.4 committed as `dfa8945`; M4.5 review complete; QA pass 1 + re-review passes 1–2 findings all addressed in an uncommitted corrective worktree; Codex re-review pass 3 pending) | Sonnet 5`high` (M4.1–M4.4), Opus 5 (M4.5)                                | Opus 5`xhigh` permission review + Codex (`gpt-5.6-sol`, `high`)                 | Brian         |
