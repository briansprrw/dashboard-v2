...
| M3 | [Glance dashboard and core tasks](./M3-glance-dashboard-and-core-tasks.md)           | Ready for PM/QA | Sonnet 5`high`                                                           | Sonnet 5`high` +think + Codex (`gpt-5.6-sol`, `high`) visual/functional QA      | Brian         |
